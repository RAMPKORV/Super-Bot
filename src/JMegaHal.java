...
public class JMegaHal implements Serializable {
     ...
     * run out of memory!
     */
    public synchronized void addDocument(String uri) throws IOException {
    ...
    public synchronized boolean knows(String word) {
    ...
    public synchronized String getSentenceReal(String word) {
        String ret = null;
        int i = 0;
        do {
            ret = getSentence(word);
            i++;
            if(i > 200) {
                break;
            }
        } while(ret.startsWith(", ") || ret.endsWith("and") || ret.endsWith("and.") || ret.endsWith(" i") || ret.endsWith(" i.") || ret.endsWith("a") || ret.endsWith("the") || ret.endsWith("by") || ret.endsWith("a.") || ret.endsWith("the.") || ret.endsWith("by."));
        return ret;
    }
     ...
     */
    public synchronized String getSentence(String word) {
