...
public class FastTag {
    ...
    static {
        ...
        try {
            ...
            if (ins == null) {
                ins = new FileInputStream("lexicon.txt");
            }
            if (ins == null) {
    ...
    public static void main(String[] args) {
        if (args.length == 0) {
            ...
            List<String> words = com.knowledgebooks.nlp.util.Tokenizer.wordsToList("I have a big penis. My penis is bigger. Red penis. Blue penises. You need more anal sex.");
